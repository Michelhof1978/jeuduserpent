...
window.onload = function(){      //fonction js onload, va permettre de lancer la fenêtre créee lorque la page s'affiche
   var canvasWidth = 900;
    ...
    function init(){     //la fonction init est un standard pour initialiser les choses
        ...
        snakee = new Snake([[6,4],[5,4],[4,4],[3,4],[2,4]],"right");// Longueur du serpent et      //création du serpent du début. le serpent est relié au body et sera placé par rapport aux paramètres du body d'où les coordonnées ds le []
