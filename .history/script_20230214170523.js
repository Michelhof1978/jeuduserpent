...
window.onload = function(){      //fonction js onload, va permettre de lancer la fenêtre créee lorque la page s'affiche
   var canvasWidth = 900;
    ...
    var ctx;
    var delay = ;        //le temps est fait en millisecond,le serpent bougera en fonction du temps (plus on rajoute du temps, plus le serpent ira vite) à chaque fois que le canvas sera rafraichi
    var xCoord = 0;
    var yCoord = 0;
