...
window.onload = function() //fonction js onload, va permettre de lancer la fenêtre créee lorque la page s'affiche
{
    ...
    {
        xCoord += 2;//création des coordonnées
        yCoord =+ 2;//création des coordonnées
        ...
        setTimeout(refreshCanvas, delay);//setTimeout = appeler la fonction refreshCanvas à chaque fois que le délais 1 seconde est passé
    }
