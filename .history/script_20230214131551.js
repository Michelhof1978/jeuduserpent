               ...
               //Nous allons donc positionner et mettre la longueur du serpent suivant les valeurs: 6 = x et 4 = y. 
                ...
                this.setDirection = function(newDirection){     //Passer la nouvelle direction au serpent
                    ...
                    switch(this.direction){
                        case "left":        //Si mes directions sont à gauche ou à droite, mes directions autorisées seront en haut et en bas
                        case "right":
                            allowedDirections=["up","down"];
                            break;
                        case "down":         //Si mes directions sont à gauche ou à droite, mes directions autorisées seront en haut et en bas
                        case "up":
