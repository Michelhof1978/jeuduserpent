...
{   var canvasWidth = 900;
    ...
    function init()//la fonction init est un standar pour initialiser les choses
    {
        ...
        snakee = new Snake( [[6,4], [5,4], [4,4]]);//création du serpent du début. le serpent est relié au body et sera placé par rapport aux paramètres du body d'où les coordonnées 
