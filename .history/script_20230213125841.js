...
window.onload = function() //fonction js onload, va permettre de lancer la fenêtre créee lorque la page s'affiche
{
    ...
    ctx.fillRect(30 , 30 , 100, 50).// création d'un petit rectangle, les 2 premiers paramètres sont x (30)(horizontale) et y(30) (verticale) du canvas, les 2 dérniers param sont la H et l. Le rectangle crée sera donc à 
}